...
abstract contract TypeVEnergyBase is ERC20, AccessControl, ERC20Snapshot, Pausable, TransferWhitelistable {
    bytes32 public constant SNAPSHOT_ROLE = keccak256("SNAPSHOT_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant WHITELIST_EDITOR_ROLE = keccak256("WHITELIST_EDITOR_ROLE");

    constructor(address[] memory initialWhitelist, address initAdminWallet) ERC20("TypeVEnergy", "TVE") TransferWhitelistable(initialWhitelist)  {
